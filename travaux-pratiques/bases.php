...
<div class="container">
    ...
    <div class="bg-dark p-3 shadow rounded-4">
        ...
        <div class="d-flex mt-2">
            <i class="bi bi-filetype-exe fs-2 text-warning text-bold"></i>
            <div class="bg-black rounded-4 p-3 flex-fill">
                <!-- Afficher chaque élément du tableau sous la forme de cards avec Bootstrap -->
                <div class="row g-4">
                    <?php foreach ($comptes as $compte) : ?>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="card border-dark mb-3">
                                <div class="card-body">
                                    <h5 class="card-title "><?= $compte["prenom"] . " " . $compte["nom"] ?></h5>
                                    <p class=" card-text"><?= $compte["email"] ?></p>
                                    <p class="card-text"><?= $compte["premium"] ? "Premium" : "Non premium" ?></p>
